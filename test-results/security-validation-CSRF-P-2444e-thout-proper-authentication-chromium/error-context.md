...
- Name: security-validation.spec.ts >> CSRF Protection >> should reject API requests without proper authentication
- Location: e2e\security-validation.spec.ts:125:7
