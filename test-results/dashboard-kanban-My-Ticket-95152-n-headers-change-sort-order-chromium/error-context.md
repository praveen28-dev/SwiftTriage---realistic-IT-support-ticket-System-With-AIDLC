...
- Name: dashboard-kanban.spec.ts >> My Tickets Page (/dashboard/my-tickets) >> sortable column headers change sort order
- Location: e2e\dashboard-kanban.spec.ts:294:7
